...
class PermissionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('users.permissions.permission_view');
    }
    ...
    private function getPermissions($role_id)
    {
        ...
        return DataTables::of($data, $role_id)
            ...
            ->addColumn('action', function ($row) {
                $action = "";
                $action .= "<a class='btn btn-xs btn-warning edit-btn' data-id='" . $row->id . "' data-toggle='modal' data-target='#edit-modal'><i class='fas fa-edit'></i></a>";
